...
*  com.lym.twogoods.message.fragment.ChatFragment.java(修改了重发的bug)
*  com.lym.twogoods.util.ImageUtil.java(增加了降低图片质量来压缩大小的方法)
*  com.lym.twogoods.ui.SendPictureActivity.java(修复了一个bug，在选好图片点击发送后进行压缩图片)
*  com.lym.twogoods.ui.ChatActivity.java(完善了更改头像，改进发送图片的功能)
*    com.lym.twogoods.message.fragment.PictureFragment.java(增
*  com.lym.twogoods.message.adapter.TipAdapter.java(完善提示)
*  com.lym.twogoods.message.config.MessageConfig.java
*  com.lym.twogoods.fragment.MessageFragment.java(完善提示)
...
*  com.lym.twogoods.service.ChatService.java(修改获取当前user空指针bug)
*  com.lym.twogoods.message.adapter.TipAdapter.java
*  com.lym.twogoods.fragment.MessageFragment.java(修改一个bug)
*  com.lym.twogoods.message.fragment.PictureFragment.java(修改了扫描图片出现的bug)